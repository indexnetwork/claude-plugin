                      ...
                      <div key={item.opportunityId} className="bg-[#F8F8F8] rounded-md p-4">
                        <div className="flex items-center justify-between gap-2 mb-3">
                          ...
                          <div className="flex gap-1.5 shrink-0">
                            <button type="button" className="bg-[#041729] text-white px-3 py-1.5 rounded-sm text-xs font-medium hover:bg-[#0a2d4a] transition-colors" onClick={() => item.userId && handleUserClick(item.userId)}>{item.primaryActionLabel ?? 'Start Chat'}</button>
