...
export default function ClientWrapper({ children }: PropsWithChildren) {
  ...
  const bareRoutes = ['/onboarding', '/oauth/callback', '/found-in-translation', '/found-in-translation-1', '/found-in-translation-2', '/found-in-translation-3', '/found-in-translation-4', '/found-in-translation-5'];
